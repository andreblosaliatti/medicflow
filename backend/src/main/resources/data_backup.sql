...
(TIMESTAMP '2025-01-10 09:00:00',
 ...
 1, 'Cefaleia', 'Paciente refere dor leve', 'Anamnese A', 'Sem diagnóstico fechado', 'Exame normal', NULL,
 'AGENDADA', 'PRESENCIAL', 250.00, 'DEBITO', FALSE, NULL, 30, FALSE, NULL, FALSE, NULL, NULL, NULL),
...
(TIMESTAMP '2025-01-10 10:00:00',
 ...
 2, 'Alergia', 'Prurido ocasional', 'Anamnese B', 'Rinite alérgica', 'Exame normal', 'Loratadina 10mg',
 'CONFIRMADA', 'PRESENCIAL', 280.00, 'CREDITO', TRUE, TIMESTAMP '2025-01-10 10:05:00', 30, FALSE, NULL, FALSE, NULL, NULL, NULL),
...
(TIMESTAMP '2025-01-11 09:30:00',
 ...
 3, 'Tontura', NULL, 'Anamnese C', 'Vertigem posicional', 'Romberg +', NULL,
 'EM_ATENDIMENTO', 'RETORNO', 0.00, 'DEBITO', FALSE, NULL, 40, TRUE, NULL, FALSE, NULL, NULL, NULL),
...
(TIMESTAMP '2025-01-11 11:00:00',
 ...
 4, 'Dor abdominal', 'Jejum 8h', 'Anamnese D', 'Suspeita colecistite', 'Dor à palpação', NULL,
 'AGENDADA', 'URGENCIA', 350.00, 'DEBITO', FALSE, NULL, 60, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-01-12 08:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drhouse'),
 5, 'Acompanhamento', NULL, 'Anamnese E', NULL, 'Exame normal', NULL,
 'CONFIRMADA', 'TELECONSULTA', 220.00, 'PIX', TRUE, TIMESTAMP '2025-01-12 08:01:00', 30, FALSE, NULL, TRUE, 'https://teleconsulta.medicflow/consultas/5', NULL, NULL),

(TIMESTAMP '2025-01-12 09:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drcameron'),
 6, 'Asma', 'Dispneia noturna', 'Anamnese F', 'Asma persistente', 'Sibilos', 'Corticoide inalatório',
 'CONCLUIDA', 'PRESENCIAL', 260.00, 'DEBITO', TRUE, TIMESTAMP '2025-01-12 09:10:00', 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-01-13 13:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drforeman'),
 7, 'Enxaqueca', NULL, 'Anamnese G', 'Migrânea', 'Exame normal', NULL,
 'CANCELADA', 'RETORNO', 0.00, 'DEBITO', FALSE, NULL, 30, TRUE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-01-13 14:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drchase'),
 8, 'Lombalgia', 'Dor há 3 semanas', 'Anamnese H', 'Lombalgia mecânica', 'Dor L5', 'Analgésico',
 'CONCLUIDA', 'PRESENCIAL', 270.00, 'PIX', TRUE, TIMESTAMP '2025-01-13 14:20:00', 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-01-14 15:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drhouse'),
 9, 'Gripe', NULL, 'Anamnese I', 'Síndrome gripal', 'Febre 38.2', NULL,
 'CONFIRMADA', 'TELECONSULTA', 230.00, 'PIX', TRUE, TIMESTAMP '2025-01-14 15:02:00', 20, FALSE, NULL, TRUE, 'https://teleconsulta.medicflow/consultas/9', NULL, NULL),

(TIMESTAMP '2025-01-14 16:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drcameron'),
 10, 'Dismenorreia', 'Cólica intensa', 'Anamnese J', NULL, 'Exame normal', 'Antiespasmódico',
 'AGENDADA', 'PRESENCIAL', 250.00, 'CREDITO', FALSE, NULL, 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-10 09:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drhouse'),
 1, 'Checkup', NULL, 'Anamnese K', 'Saudável', 'Exame normal', NULL,
 'CONCLUIDA', 'PRESENCIAL', 300.00, 'DEBITO', TRUE, TIMESTAMP '2025-02-10 09:30:00', 40, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-10 10:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drcameron'),
 2, 'Alergia pó', NULL, 'Anamnese L', 'Rinite', 'Exame normal', 'Anti-histamínico',
 'CONCLUIDA', 'RETORNO', 200.00, 'CREDITO', TRUE, TIMESTAMP '2025-02-10 10:15:00', 30, TRUE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-11 09:30:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drforeman'),
 3, 'Tremor', NULL, 'Anamnese M', 'Tremor essencial', 'Leve tremor', NULL,
 'AGENDADA', 'PRESENCIAL', 250.00, 'DEBITO', FALSE, NULL, 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-11 11:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drchase'),
 4, 'Náusea', 'Desde ontem', 'Anamnese N', NULL, 'Exame normal', 'Ondansetrona',
 'CONFIRMADA', 'TELECONSULTA', 240.00, 'PIX', TRUE, TIMESTAMP '2025-02-11 11:05:00', 20, FALSE, NULL, TRUE, 'https://teleconsulta.medicflow/consultas/14', NULL, NULL),

(TIMESTAMP '2025-02-12 08:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drhouse'),
 5, 'Dor torácica', 'Esforço físico', 'Anamnese O', 'Musculoesquelética', 'Dor à palpação', NULL,
 'CONCLUIDA', 'PRESENCIAL', 320.00, 'CREDITO', TRUE, TIMESTAMP '2025-02-12 08:20:00', 40, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-12 09:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drcameron'),
 6, 'Urticária', NULL, 'Anamnese P', NULL, 'Pápulas', 'Anti-histamínico',
 'CONCLUIDA', 'PRESENCIAL', 260.00, 'DEBITO', TRUE, TIMESTAMP '2025-02-12 09:05:00', 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-13 13:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drforeman'),
 7, 'Parestesia', NULL, 'Anamnese Q', 'Ansiedade', 'Exame normal', NULL,
 'EM_ATENDIMENTO', 'RETORNO', 180.00, 'PIX', FALSE, NULL, 30, TRUE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-13 14:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drchase'),
 8, 'Sinusite', 'Secreção espessa', 'Anamnese R', 'Sinusite bacteriana', 'Dor seios face', 'Amoxicilina',
 'CONCLUIDA', 'PRESENCIAL', 270.00, 'CREDITO', TRUE, TIMESTAMP '2025-02-13 14:25:00', 30, FALSE, NULL, FALSE, NULL, NULL, NULL),

(TIMESTAMP '2025-02-14 15:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drhouse'),
 9, 'Resfriado', NULL, 'Anamnese S', 'Viral', 'Exame normal', NULL,
 'CONFIRMADA', 'TELECONSULTA', 230.00, 'PIX', TRUE, TIMESTAMP '2025-02-14 15:03:00', 20, FALSE, NULL, TRUE, 'https://teleconsulta.medicflow/consultas/19', NULL, NULL),

(TIMESTAMP '2025-02-14 16:00:00',
 (SELECT usuario_id FROM tb_medicos m JOIN tb_usuarios u ON u.id = m.usuario_id WHERE u.login = 'drcameron'),
 10, 'Tensão pré-menstrual', 'Irritabilidade', 'Anamnese T', NULL, 'Exame normal', 'Sintomáticos',
 'AGENDADA', 'RETORNO', 200.00, 'DEBITO', FALSE, NULL, 30, TRUE, NULL, FALSE, NULL, NULL, NULL);

-- ---------------------------------------------------------------------

INSERT INTO medicamento_base (id, nome_comercial)
VALUES
(nextval('medicamento_base_seq'), 'Paracetamol 750mg'),
(nextval('medicamento_base_seq'), 'Ibuprofeno 200mg'),
(nextval('medicamento_base_seq'), 'Dipirona 500mg'),
(nextval('medicamento_base_seq'), 'Amoxicilina 500mg'),
(nextval('medicamento_base_seq'), 'Azitromicina 500mg'),
(nextval('medicamento_base_seq'), 'Loratadina 10mg'),
(nextval('medicamento_base_seq'), 'Prednisona 20mg'),
(nextval('medicamento_base_seq'), 'Omeprazol 20mg'),
(nextval('medicamento_base_seq'), 'Ranitidina 150mg'),
(nextval('medicamento_base_seq'), 'Ondansetrona 8mg'),
(nextval('medicamento_base_seq'), 'Losartana 50mg'),
(nextval('medicamento_base_seq'), 'Hidroclorotiazida 25mg'),
(nextval('medicamento_base_seq'), 'Metformina 850mg'),
(nextval('medicamento_base_seq'), 'Glibenclamida 5mg'),
(nextval('medicamento_base_seq'), 'Atorvastatina 20mg'),
(nextval('medicamento_base_seq'), 'Sinvastatina 20mg'),
(nextval('medicamento_base_seq'), 'AAS 100mg'),
(nextval('medicamento_base_seq'), 'Clopidogrel 75mg'),
(nextval('medicamento_base_seq'), 'Salbutamol Spray'),
(nextval('medicamento_base_seq'), 'Budesonida Inalatória'),
(nextval('medicamento_base_seq'), 'Cetirizina 10mg'),
(nextval('medicamento_base_seq'), 'Naproxeno 250mg'),
(nextval('medicamento_base_seq'), 'Cefalexina 500mg'),
(nextval('medicamento_base_seq'), 'Ciprofloxacino 500mg'),
(nextval('medicamento_base_seq'), 'Fluconazol 150mg'),
(nextval('medicamento_base_seq'), 'Diclofenaco 50mg'),
(nextval('medicamento_base_seq'), 'Amoxicilina+Clav 875/125'),
(nextval('medicamento_base_seq'), 'Albendazol 400mg'),
(nextval('medicamento_base_seq'), 'Dexametasona 4mg'),
(nextval('medicamento_base_seq'), 'Furosemida 40mg');
...
VALUES
(3, 12, 'AGENDADO', CURRENT_TIMESTAMP + INTERVAL '1 day', 'Dor abdominal, avaliar hepatobiliar.', 'USG marcado para amanhã 09h'),
(3, 11, 'AGENDADO', CURRENT_TIMESTAMP + INTERVAL '2 day', 'Dispneia leve, RX de tórax.', 'Radiografia no mesmo serviço');

INSERT INTO exame_solicitado (consulta_id, exame_base_id, status, data_coleta, data_resultado, justificativa, observacoes)
VALUES
(4, 2, 'REALIZADO', CURRENT_TIMESTAMP - INTERVAL '2 day', CURRENT_TIMESTAMP - INTERVAL '1 day', 'Glicemia de jejum por suspeita de DM.', 'Resultado disponível no prontuário'),
(4, 3, 'REALIZADO', CURRENT_TIMESTAMP - INTERVAL '2 day', CURRENT_TIMESTAMP - INTERVAL '1 day', 'Perfil lipídico: colesterol total.', 'Valores limítrofes'),
(5, 7, 'REALIZADO', CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP - INTERVAL '6 hour', 'Inflamação: PCR.', 'PCR discretamente elevado');
...
INSERT INTO exame_solicitado (consulta_id, exame_base_id, status, data_coleta, justificativa, observacoes)
VALUES
(7, 13, 'AGENDADO', CURRENT_TIMESTAMP + INTERVAL '3 day', 'Arritmia: solicitar ECG.', 'Agendado via convênio');

INSERT INTO exame_solicitado (consulta_id, exame_base_id, status, data_coleta, data_resultado, justificativa, observacoes)
VALUES
(8, 15, 'REALIZADO', CURRENT_TIMESTAMP - INTERVAL '5 day', CURRENT_TIMESTAMP - INTERVAL '3 day', 'Dor no joelho, suspeita de lesão.', 'Ressonância concluída, laudo anexado');
