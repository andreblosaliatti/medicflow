...
import com.inflowia.medicflow.services.exceptions.ForbiddenException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> generic(Exception e, HttpServletRequest request) {
        ...
        CustomError err = new CustomError(Instant.now(), status.value(), "Erro interno inesperado", request.getRequestURI());
        return ResponseEntity.status(status).body(err);
    }
}
