...
-- ===== Enums =====
CREATE TYPE perfil_enum AS ENUM ('ADMIN','MEDICO','SECRETARIA','ATENDENTE','ENFERMEIRO','PACIENTE');
CREATE TYPE tipo_consulta_enum AS ENUM ('PRESENCIAL','TELECONSULTA','RETORNO','URGENCIA');
CREATE TYPE status_consulta_enum AS ENUM ('AGENDADA','CONFIRMADA','EM_ATENDIMENTO','CONCLUIDA','CANCELADA','NAO_COMPARECEU');
